...
//         {/* <div className='flex flex-col md:flex-row mb-20 gap-6 flex-wrap'> */}
    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          ...
          <p>
            Welcome to CareNest, your trusted partner in managing your healthcare
            needs conveniently and efficiently. At CareNest, we understand the
            challenges individuals face when it comes to scheduling doctor
            appointments and managing their health records.
          </p>

          <p>
            CareNest is committed to excellence in healthcare technology. We
            ...
            CareNest is here to support you every step of the way.
          </p>

          <b className='text-gray-800'>Our Vision</b>

          <p>
            Our vision at CareNest is to create a seamless healthcare experience
      ...
      <div className='flex flex-col md:flex-row mb-20'>
        ...
        <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 cursor-pointer'>
          ...
          <p>
            Easy access to a network of trusted healthcare professionals in
            your area.
          </p>
